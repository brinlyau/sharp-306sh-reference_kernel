...
struct usb_phy {
	...
	/* notify charge info to PMIC */
	int	(*notify_chg_info)(struct usb_phy *otg,
				unsigned mA);
#endif /* CONFIG_USB_MSM_OTG_SH_CUST */

#ifdef CONFIG_USB_SH_CUST_NON_STANDARD_CHARGE
	int	(*notify_enumeration_started)(struct usb_phy *otg);
...
#ifdef CONFIG_USB_MSM_OTG_SH_CUST
static inline int
otg_notify_chg_info(struct usb_phy *otg, unsigned mA)
{
	return otg->notify_chg_info(otg, mA);
}
/* for MHL */
extern void msm_notify_chg_info_from_mhl(unsigned mA);
extern void msm_notify_chg_info_from_mhl_irregular(unsigned mA);
...
#ifdef CONFIG_USB_SH_CUST_NON_STANDARD_CHARGE
static inline int
otg_notify_enumeration_started(struct usb_phy *phy)
{
	return phy->notify_enumeration_started(phy);
}
#endif /* CONFIG_USB_SH_CUST_NON_STANDARD_CHARGE */
